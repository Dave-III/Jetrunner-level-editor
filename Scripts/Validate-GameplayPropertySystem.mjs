...
requireText(main, 'record.bronzeTime < record.silverTime', 'Bronze-after-Silver medal ordering');
requireText(main, 'if (medalError) errors.push(medalError)', 'medal ordering export validation');
requireText(schema, "bronzeTime: numberProperty", 'Bronze medal editor target');
...
requireText(compiler, 'level.medalTimes.bronzeTime', 'Bronze runtime medal field');
